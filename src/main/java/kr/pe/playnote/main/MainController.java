...
public class MainController {
	...
	public String home(Locale locale, Model model,HttpServletRequest request) {
	    ...
	    logger.info("home locale.toString {}.", locale.toString()); // localeResolver 로부터 Locale 을 출력해 봅니다.
    ...
    public String messageChange(Locale locale, Model model,HttpServletRequest request) {
        ...
        logger.info("locale.toString {}.", locale.toString()); // localeResolver 로부터 Locale 을 출력해 봅니다.
